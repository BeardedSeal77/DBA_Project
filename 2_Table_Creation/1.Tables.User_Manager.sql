...
DROP TABLE tblOrderDetail   CASCADE CONSTRAINTS;
DROP TABLE tblOrder         CASCADE CONSTRAINTS;
DROP TABLE tblCustomer      CASCADE CONSTRAINTS;
DROP TABLE tblBookAuthor    CASCADE CONSTRAINTS;
DROP TABLE tblBook          CASCADE CONSTRAINTS;
DROP TABLE tblAuthor        CASCADE CONSTRAINTS;
